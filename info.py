...
API_ID = int(environ.get('API_ID', '23394197'))
API_HASH = environ.get('API_HASH', 'c479cdf25a47b32295ff0d6b15709aac')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002804738225') # Corrected AUTH_CHANNEL to the provided channel ID
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002829192804') # Updated to your provided value
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Channel Is For Index Request 
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', '-1002802211490'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002829192804')).split()] # Updated to your provided value
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vishnusaketh07:moviesai25@cluster0.bdifagm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
IMDB = False # Set to False as requested
